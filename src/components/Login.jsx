...
const Login = () => {
    ...
    const login = async () => {
        try {
            ...
            const loginResponse = await axios.post('http://54.145.206.222:8080/api/user/login', {
                username: username,
                password: password
            });
            ...
            const detailsResponse = await axios.get("http://54.145.206.222:8080/api/user/details", {
                headers: {
