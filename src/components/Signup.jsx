...
const Signup = () => {
    ...
    const signup = async () => {
        ...
        try {
            ...
            const userResponse = await axios.post('http://backend:8080/api/user/signup', user);
            ...
            if (user.role === "AUTHOR") {
                ...
                try {
                    ...
                    const authorResponse = await axios.post('http://backend:8080/api/author/register', authorPayload);
