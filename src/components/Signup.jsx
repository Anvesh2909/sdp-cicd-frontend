...
const Signup = () => {
    ...
    const signup = async () => {
        ...
        try {
            ...
            const userResponse = await axios.post('http://54.234.194.193:8080/api/user/signup', user);
            ...
            if (user.role === "AUTHOR") {
                ...
                try {
                    ...
                    const authorResponse = await axios.post('http://54.234.194.193:8080/api/author/register', authorPayload);
