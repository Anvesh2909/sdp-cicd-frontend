...
const Signup = () => {
    ...
    const signup = async () => {
        ...
        try {
            ...
            const userResponse = await axios.post('http://18.208.212.21:8080/api/user/signup', user);
            ...
            if (user.role === "AUTHOR") {
                ...
                try {
                    ...
                    const authorResponse = await axios.post('http://18.208.212.21:8080/api/author/register', authorPayload);
