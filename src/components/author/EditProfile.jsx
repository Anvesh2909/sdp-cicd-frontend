...
const EditProfile = () => {
    ...
    const upload = async () => {
        ...
        try {
            const response = await axios.post("http://54.173.153.82:8080/api/author/upload/profile-pic", formData,
                {
                    headers:
    ...
    useEffect(() => {
        const getAuthor = async () => {
            try {
                const response = await axios.get("http://54.173.153.82:8080/api/author/get", {
