...
const EditProfile = () => {
    ...
    const upload = async () => {
        ...
        try {
            const response = await axios.post("http://18.208.212.21:8080/api/author/upload/profile-pic", formData,
                {
                    headers:
    ...
    useEffect(() => {
        const getAuthor = async () => {
            try {
                const response = await axios.get("http://18.208.212.21:8080/api/author/get", {
